...
class ChatScreen(Screen):
    ...
    def __init__(self) -> None:
        ...
        self.model = os.getenv("RELAY_MODEL") or os.getenv("CATGPT_MODEL") or "catgpt-browser"
    ...
    def _show_help(self) -> None:
        lines = [
            ...
            "  Tip: Set RELAY_API_URL / RELAY_API_KEY / RELAY_MODEL as env vars[/]",
        ]
...
def chat(
    ...
    if api_url:
        os.environ["RELAY_API_URL"] = api_url
    if api_key:
        os.environ["RELAY_API_KEY"] = api_key
    if model:
        os.environ["RELAY_MODEL"] = model
    CatGPTApp().run()
