...
|---|---|---|---|
| `model` | string | yes | `claude-browser`, `gemini-browser`, or `catgpt-browser` |
...
| Behavior | Claude | Gemini | ChatGPT |
|---|---|---|---|
| Model ID | `claude-browser` | `gemini-browser` | `catgpt-browser` |
| Image generation | Not supported (501) | Not supported (501) | Supported (DALL-E) |
| Table rendering | Tab-separated text | Markdown | Markdown with pipes |
| Avg response time | 15-20s | varies | 7-10s |
